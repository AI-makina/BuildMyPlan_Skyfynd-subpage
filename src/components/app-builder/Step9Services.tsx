          ...
          {oneTimeServices.map((service) => {
            ...
            return (
              ...
              >
                ...
                <span className={`font-semibold shrink-0 ${isSelected ? 'text-[var(--accent-purple)]' : 'text-white'}`}>
            ...
            return (
              <div key={service.id} className="space-y-2">
                ...
                >
                  ...
                  {!hasOptions && (
                    <span className={`font-semibold shrink-0 ${isSelected ? 'text-[var(--accent-pink)]' : 'text-white'}`}>
                        ...
                        return (
                          <motion.button
                            ...
                            className={`
                              ...
                              ${isOptionSelected
                                ? 'bg-[var(--accent-pink)]/15 border border-[var(--accent-pink)]/60'
                                : 'bg-[var(--bg-secondary)]/60 border border-[var(--border-subtle)] hover:border-[var(--accent-pink)]/30'
                              }
                            `}
                          >
                            <div className="flex items-center gap-3">
                            ...
                            <span className={`text-sm font-semibold shrink-0 ${isOptionSelected ? 'text-[var(--accent-pink)]' : 'text-white'}`}>
