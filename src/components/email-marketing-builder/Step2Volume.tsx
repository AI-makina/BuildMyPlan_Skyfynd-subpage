              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    `}>
                      <Mail className={`w-5 h-5 ${isSelected ? 'text-[var(--accent-purple)]' : 'text-[var(--text-secondary)]'}`} />
                    </div>
                ...
                <div className="mt-2 flex flex-col gap-1">
                  ...
                  <span className={`text-sm font-medium ${option.customQuote ? 'text-[var(--accent-orange)]' : 'text-[var(--accent-purple)]'}`}>
                    {formatPrice(option)}
                  </span>
                </div>
              </motion.button>
